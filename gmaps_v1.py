...
def build_gmaps_url(term: str, location: str):
...
def get_address_from_place_url(place_url: str, max_wait: int = 10):
    """
...
def _gmaps_collect_from_list_optimized(container, limit, origin_coords):
